...
<head>
    ...
    <title>santosvdw | portofolio</title>
...
<body>
    <div class="content">
        <div class="container">
            <nav>
                <span class="santos">
                    <h2>santos<span class="blue">vdw</span></h2>
                </span>
        ...
        <div class="container">
            <header>
                <img src="/dist/import/hero-header.png" alt="">   
            </header>
        </div>
            ...
            <div class="grid">
                <div class="column">
                    <div class="col  picture">
                        <img src="/dist/import/shoes.jpg" alt="">
                    </div>
                    <div class="col">
                        <div class="text">
                            <h3>Zoek jij een website?</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem officia, magnam accusamus, voluptatem doloremque corporis cupiditate ratione obcaecati sapiente ipsam cum, esse fuga quos magni quam? Sunt sed doloremque temporibus deserunt! Minus, in nemo ipsam, rem, aperiam possimus impedit aspernatur reiciendis enim sed earum voluptas. Architecto veritatis deleniti facere! Necessitatibus?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <footer>
                <span><p>santos van der wansem, 2022</p></span>

                <span class="icons">
                    <a href="mailto:srrvdwansem@gmail.com" target="_blank">   
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg xmlns="http://www.w3.org/2000/svg" id="mail" viewBox="0 0 24 24" class="icons" fill="CurrentColor">
                            <path d="M19,1H5A5.006,5.006,0,0,0,0,6V18a5.006,5.006,0,0,0,5,5H19a5.006,5.006,0,0,0,5-5V6A5.006,5.006,0,0,0,19,1ZM5,3H19a3,3,0,0,1,2.78,1.887l-7.658,7.659a3.007,3.007,0,0,1-4.244,0L2.22,4.887A3,3,0,0,1,5,3ZM19,21H5a3,3,0,0,1-3-3V7.5L8.464,13.96a5.007,5.007,0,0,0,7.072,0L22,7.5V18A3,3,0,0,1,19,21Z"/>
                        </svg>
                    </a>
        
                    <a href="https://https://github.com/" target="_blank"> 
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" class="icons" id="github" fill="CurrentColor">
                            <g>
                    ...
                    <a href="https://twitter.com/wjwsantos" target="_blank">   
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" class="icons" id="twitter" fill="CurrentColor">
                    ...
                    <a href="https://instagram.com/santosvdw/" target="_blank">         
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" class="icons" id="instagram" fill="CurrentColor">
                            <g>
        ...
        <div class="icons">
            ...
            <a href="https://github.com/santosvdw" target="_blank"> 
                <?xml version="1.0" encoding="UTF-8"?>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" class="icons" id="github" fill="CurrentColor">
                    <g>
                        <path style="fill-rule:evenodd;clip-rule:evenodd;" d="M12,0.296c-6.627,0-12,5.372-12,12c0,5.302,3.438,9.8,8.206,11.387   c0.6,0.111,0.82-0.26,0.82-0.577c0-0.286-0.011-1.231-0.016-2.234c-3.338,0.726-4.043-1.416-4.043-1.416   C4.421,18.069,3.635,17.7,3.635,17.7c-1.089-0.745,0.082-0.729,0.082-0.729c1.205,0.085,1.839,1.237,1.839,1.237   c1.07,1.834,2.807,1.304,3.492,0.997C9.156,18.429,9.467,17.9,9.81,17.6c-2.665-0.303-5.467-1.332-5.467-5.93   c0-1.31,0.469-2.381,1.237-3.221C5.455,8.146,5.044,6.926,5.696,5.273c0,0,1.008-0.322,3.301,1.23   C9.954,6.237,10.98,6.104,12,6.099c1.02,0.005,2.047,0.138,3.006,0.404c2.29-1.553,3.297-1.23,3.297-1.23   c0.653,1.653,0.242,2.873,0.118,3.176c0.769,0.84,1.235,1.911,1.235,3.221c0,4.609-2.807,5.624-5.479,5.921   c0.43,0.372,0.814,1.103,0.814,2.222c0,1.606-0.014,2.898-0.014,3.293c0,0.319,0.216,0.694,0.824,0.576   c4.766-1.589,8.2-6.085,8.2-11.385C24,5.669,18.627,0.296,12,0.296z"/>
